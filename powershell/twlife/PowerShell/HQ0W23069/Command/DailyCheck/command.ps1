...
$HostInfo | out-file d:\Command\Date.txt
$ArrayA = Get-Content d:\Command\Date.txt
$ArrayB =  Get-Content d:\Command\Date1.txt
[array]$ArrayC = $ArrayA[1,2,3,4,5] + $ArrayB[3,4] + $ArrayA[6..100]
Out-File  -InputObject  $ArrayC  -FilePath d:\Command\Check.txt
#Function Send-Mail
Send-MailMessage -smtpserver hq0w23074 -to bchang@twlife.com.tw,jerrywu@twlife.com.tw -from SIM@twlife.com.tw -Subject "CheckList" -Encoding ([System.Text.Encoding]::UTF8) -Attachment "d:\Command\Check.txt"
Remove-Item d:\Command\Date.txt
Remove-Item d:\Command\Date1.txt
Remove-Item d:\Command\Check.txt
