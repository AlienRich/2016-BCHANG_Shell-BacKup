...
$ArrayA = Get-Content d:\Date.txt
$ArrayB =  Get-Content d:\Date1.txt
[array]$ArrayC = $ArrayA[1,2,3,4,5] + $ArrayB[3,4] + $ArrayA[6..100]
Out-File  -InputObject  $ArrayC  -FilePath Check.txt
#Function Send-Mail
...
Remove-Item d:\Date1.txt
Remove-Item d:\Check.txt
