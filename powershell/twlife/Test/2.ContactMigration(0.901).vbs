...
Function ContactMigration(NamesFile,ExchServerName,UserID)
	...
	'strCmdContact = "c:\windows\system32\runas.exe /user:edu\exadmin ""c:\Migrate\TM\TMB8.EXE /F C:\Migrate\TM\contact.DAT /SL /Progress /L /S C:\Migrate\TM /d c:\ /IM /NCFG /GN ROOT /D73 /EXALL"""
    strCmdContact="cmd /c c:\Migrate\TM\TMB8.EXE /F C:\Migrate\TM\Contact.DAT /SL /Progress /L /S C:\Migrate\TM /d c:\Migrate /IM /NCFG /GN ROOT /D73 /EXALL /SKIP /CF \u9023\u7d61"
