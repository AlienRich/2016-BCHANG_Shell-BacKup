...
WSHShell.RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings\ProxyOverride","10.*,172.*,192.168.*,*.asrock.com.tw,*.pegatron*,*.unihancorp.*,*.asfly.com.tw,*.ri-kuan.com,*.ri-teng.com.cn,<local>,","REG_SZ"
